...
use Shop\Shop;
use Shop\Item;
use Shop\Strategy\StrategyHandler;
use Shop\Strategy\StrategyManager;
...
$app->setStrategyManager(new StrategyManager());
$app->setStrategyHandler(new StrategyHandler());
